...
var TabContext = React17.createContext(null);
...
var NavItem = React18.forwardRef((_ref, ref) => {
  let {
    as: Component = Button_default,
    active,
    eventKey
  ...
  return (0, import_jsx_runtime15.jsx)(Component, Object.assign({}, options, props, {
    ref
  }));
});
...
var NavLink = React19.forwardRef(({
  bsPrefix,
  className,
  as: Component = Anchor_default,
  active,
...
var NavDropdown = React20.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime18.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames9.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime17.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime17.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
...
//# sourceMappingURL=chunk-KF2464PQ.js.map
